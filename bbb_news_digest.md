...
### ⚖️ Vercel 如何在 AI 代理上運作：96% 的行銷、93% 的支援以及重新吸收的 SDR 團隊。與 CPO Tom Occhino 深入探討
- **題材**: `光通訊與矽光子` | **重要性**: `60`
- **來源**: Saastr.com (2026-06-06T09:21:35Z)
- **AI 判讀**: 屬「光通訊與矽光子」題材之中性消息。【一般資訊】可作為題材背景知識的補充。
- **摘要**: Tom Occhino 建置的基礎設施規模幾乎是 B2B 領域無人能及的。他在 Facebook 工作了 12 年多，在那裡他共同創建了 React 和 React Native，並塑造了仍在運行的大部分網路的開源工具…
- [原文連結](https://www.saastr.com/how-vercel-runs-on-ai-agents-96-of-marketing-93-of-support-and-an-sdr-team-reabsorbed-a-deep-dive-with-cpo-tom-occhino/)
